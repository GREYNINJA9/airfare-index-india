...
def _get_connector():
    ...
    if _global_connector is None:
        _global_connector = PostgresConnector()
...
def reset_connection(dsn: str | None = None):
    ...
    # Default to DATABASE_URL or local development DSN for tests
    import os
    target_dsn = dsn or os.environ.get("DATABASE_URL") or DEFAULT_PG_DSN
