...
from backend.tests.unit.test_fare_model import _valid_fare
...
def test_dedup_distinguishes_by_cabin_class():
    ...
    from backend.models.fare import CabinClass
...
def test_dedup_distinguishes_by_trip_type():
    from backend.models.fare import TripType
...
def test_dedup_ignores_provenance_differences():
    ...
    from backend.models.fare import RawFareSource, SourceType
