...
from backend.tests.unit.test_fare_model import _valid_source  # noqa: F401, noqa: T001
...
def test_get_fares_by_route_ordered_by_scraped_at(db):
    ...
    from backend.models.fare import CabinClass, RawFareSource, SourceType, TripType
    from backend.models.route import Route
